...
class TypeRow(wx.Panel):
    def __init__(self, parent, type_code, type_name, on_change_callback):
        ...
        self.checkbox.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        ...
        help_btn.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, faceName="Arial"))
        ...
        count_lbl.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))

        self.count_input = wx.TextCtrl(self, value="5", size=(45, -1), style=wx.TE_CENTER)
        self.count_input.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        self.count_input.Bind(wx.EVT_TEXT, self._on_count)

        sizer.Add(self.checkbox, proportion=1, flag=wx.ALIGN_CENTER_VERTICAL | wx.LEFT, border=4)
...
class PreviewDialog(wx.Dialog):
    def __init__(self, parent, questions_data):
        super().__init__(parent, title="题目预览", size=(540, 620),
        ...
        total = 0
        for section_name, questions, _ in questions_data:
            sec_label = wx.StaticText(scroll, label=("【%s】" % section_name))
            sec_label.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD))
            ...
            for q in questions:
                ...
                q_label.SetFont(wx.Font(12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
                q_label.SetForegroundColour(COLOR_TEXT_SEC)
                scroll_sizer.Add(q_label, flag=wx.LEFT, border=20)

        scroll.SetSizer(scroll_sizer)
        main_sizer.Add(scroll, proportion=1, flag=wx.EXPAND | wx.LEFT | wx.RIGHT, border=8)

        total_label = wx.StaticText(self, label=("共 %d 题" % total))
        total_label.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
        ...
        main_sizer.Add(btn_sizer, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, border=16)
...
class MainFrame(wx.Frame):
    def __init__(self):
        super().__init__(None, title="三年级数学练习", size=(700, 600),
    ...
    def _build_ui(self):
        ...
        htitle.SetFont(wx.Font(18, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD))
        ...
        btn_sel.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        ...
        btn_clr.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        ...
        self.rand_input = wx.TextCtrl(bottom_bar, value="5", size=(45, -1), style=wx.TE_CENTER)
        self.rand_input.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        self.rand_input.Bind(wx.EVT_TEXT, self._on_random)

        btn_rnd = wx.Button(bottom_bar, label="随机")
        btn_rnd.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))
        ...
        self.btn_preview.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, faceName="Microsoft YaHei"))
        ...
        self.btn_generate.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, faceName="Microsoft YaHei"))
        ...
        batch_lbl.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))

        self.batch_input = wx.TextCtrl(bottom_bar, value="10", size=(45, -1), style=wx.TE_CENTER)
        self.batch_input.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="Microsoft YaHei"))

        self.btn_batch = wx.Button(bottom_bar, label="批量生成PDF")
        self.btn_batch.SetFont(wx.Font(11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, faceName="Microsoft Yahei"))
        ...
        # 按钮按不同比例分配窗口宽度
        bottom_sizer.Add(btn_sel, proportion=1, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=4)
        bottom_sizer.Add(btn_clr, proportion=1, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=4)
        bottom_sizer.Add(self.rand_input, proportion=0, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=2)
        bottom_sizer.Add(btn_rnd, proportion=1, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=4)
        bottom_sizer.Add(self.btn_preview, proportion=2, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=4)
        bottom_sizer.Add(self.btn_generate, proportion=2, flag=wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, border=4)
        bottom_sizer.Add(batch_lbl, proportion=0, flag=wx.ALIGN_CENTER_VERTICAL | wx.LEFT, border=4)
        bottom_sizer.Add(self.batch_input, proportion=0, flag=wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, border=2)
        ...
        log_title.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD))
        log_title.SetForegroundColour(COLOR_TEXT)
        log_sizer.Add(log_title, flag=wx.LEFT | wx.TOP, border=8)
        
        self.log_text = wx.TextCtrl(log_panel, style=wx.TE_MULTILINE | wx.TE_READONLY | wx.TE_WORDWRAP)
        self.log_text.SetBackgroundColour(wx.Colour(255, 255, 255))
        self.log_text.SetForegroundColour(COLOR_TEXT)
        self.log_text.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, faceName="SimSun"))
        log_sizer.Add(self.log_text, proportion=1, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | wx.BOTTOM, border=4)
    ...
    def _get_selected(self):
        return [(row.type_code, row.count) for row in self.all_rows if row.is_selected()]
    ...
    def _on_generate(self, e):
        ...
        dlg = wx.FileDialog(self, "保存试卷", wildcard=wildcard,
